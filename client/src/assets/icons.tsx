...
export const TikTokIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => {
  return (
    ...
    >
      ...
      <path d="M20 10c-1.5-1.5-3.5-2-5.5-1.5-.5-1.5-1.5-3-3.5-3.5-2-.5-4 0-5.5 1.5" />
      <path d="M20 10v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8" />
      <path d="M14.5 15c-.5 0-1.5-.5-1.5-1.5v-7c0-.5.5-1.5 1.5-1.5 .97 0 1.89.45 2.5 1.2" />
    </svg>
  );
};
...
export const SpotifyIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => {
  return (
    ...
    >
      ...
      <path d="M8 16.42c0 0 4-1.42 8-.42" />
      <path d="M8 12.42c0 0 4-1.42 8-.42" />
      <path d="M8 8.42c0 0 4-1.42 8-.42" />
    </svg>
  );
};

export const SoundCloudIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
    ...
    >
      <path d="M2 12h2v6H2z" />
      <path d="M6 6h2v12H6z" />
      <path d="M10 8h2v10h-2z" />
      <path d="M14 4h2v14h-2z" />
      <path d="M18 5h4v12h-4z" />
    </svg>
  );
};

export const ITunesIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
...
export const YouTubeIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => {
  return (
    <svg 
      ...
      className={className}
    >
      <path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.5 49.5 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.5 49.5 0 0 1-16.2 0A2 2 0 0 1 2.5 17" />
      <path d="m10 15 5-3-5-3z" />
    </svg>
  );
};

export const VevoIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
...
export const DollarIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={size} 
