...
export function MainMenu() {
  ...
  useEffect(() => {
    ...
    // No need for custom cleanup as useAudio store will handle this
  }, []);
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-gradient-to-r from-gray-900 via-purple-950 to-gray-900 text-white p-6 relative overflow-hidden">
      ...
      <Dialog open={aboutDialogOpen} onOpenChange={setAboutDialogOpen}>
        <DialogContent className="bg-gray-900 border-gray-800 text-white max-w-[90vw] sm:max-w-md" aria-describedby="about-description">
          <DialogHeader>
            <DialogTitle className="text-xl sm:text-2xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-amber-300 to-pink-500">About RES</DialogTitle>
            <DialogDescription id="about-description" className="text-gray-400 text-center pt-2">
