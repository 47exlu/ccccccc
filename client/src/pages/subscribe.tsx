        ...
        {selectedPlan && (
          <>
            ...
            <div className="max-w-md mx-auto mb-8">
              ...
              {paymentMethod === 'paypal' && (
                <div className="mt-4">
                  <div className="p-5 border border-yellow-300 bg-yellow-50 rounded-md text-center">
                    <p className="mb-3 font-medium text-yellow-800">PayPal integration has been removed</p>
                    <p className="text-sm text-yellow-700">
                      PayPal payment option has been disabled as requested.
                      Please use the credit card option instead.
                    </p>
                  </div>
                </div>
              )}
