...
export function MusicProduction() {
  ...
  const handleCreateSong = () => {
    ...
    // If subscription check passes or not needed, create the song
                  ...
                  {aiRappers
                    ...
                    .map(rapper => (
                      ...
                      >
                        ...
                        <Badge className={`${
                          rapper.relationshipStatus === "friend" ? 'bg-green-600' : 'bg-gray-600'
                        }`}>
                          {rapper.relationshipStatus === "friend" ? "Friend" : "Neutral"}
                        </Badge>
                      </div>
                    ))}
                </div>
