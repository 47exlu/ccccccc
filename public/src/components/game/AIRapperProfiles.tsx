                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs text-gray-400 flex items-center">
                            <span className={getRelationshipColor(rapper.relationshipStatus)}>
                              {getRelationshipEmoji(rapper.relationshipStatus)}
                            </span>
                  ...
                  <Card className="bg-gray-900/50 border-gray-800">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          <span className={`text-lg ${getRelationshipColor(selectedRapper.relationshipStatus)}`}>
                            {getRelationshipEmoji(selectedRapper.relationshipStatus)}
                          </span>
                          <span className="ml-2 capitalize">{selectedRapper.relationshipStatus}</span>
                        </div>
                      </div>
                        ...
                        <div className="space-y-4">
                          {getPlayerCollaborations.length > 0 ? (
                            <>
                              ...
                              {getPlayerCollaborations.map((song, index) => (
                                <div key={song.id} className="flex items-center py-2 hover:bg-gray-800/30 rounded px-2 border border-green-900/20">
                                  ...
                                  <div className={`w-10 h-10 ml-2 mr-3 flex items-center justify-center ${
                                    ...
                                    song.icon === "diamond" ? "bg-gradient-to-br from-blue-400 to-purple-600" :
                                    song.icon === "crown" ? "bg-gradient-to-br from-yellow-300 to-yellow-500" :
                                    "bg-gray-800"
                                  }`}>
                              ...
                              <div className="text-sm text-green-400 mt-3">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span>Estimated gain for {selectedRapper.name} from your features: 
                                    {formatNumber(getPlayerCollaborations.reduce((total, song) => total + song.streams * 0.3, 0))} streams
                                  </span>
                                </div>
                              </div>
                            </>
                        ...
                        <div>
                          ...
                          <ProgressBar 
                            value={Math.min(100, stats.reputation * 
                              (selectedRapper.relationshipStatus === 'friend' ? 1.2 : 
                               selectedRapper.relationshipStatus === 'rival' ? 0.8 : 
                               selectedRapper.relationshipStatus === 'enemy' ? 0.5 : 1))}
                            max={100}
                            color={selectedRapper.relationshipStatus === 'friend' ? "success" : 
                                  selectedRapper.relationshipStatus === 'enemy' ? "danger" : "default"}
                            size="sm"
                          />
                        </div>
