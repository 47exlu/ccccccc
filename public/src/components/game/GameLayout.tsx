...
export function GameLayout({ children }: GameLayoutProps) {
  ...
  // Play background music when it's available and not muted
  useEffect(() => {
    if (backgroundMusic) {
      if (isMuted) {
        ...
        >
          {isMuted ? (
            ...
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M19.07 5.93C20.9447 7.8049 21.9979 10.3489 21.9979 13C21.9979 15.6511 20.9447 18.1951 19.07 20.07" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          )}
        </button>
      </div>
